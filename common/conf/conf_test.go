...
func TestReadResellerOptions(t *testing.T) {
	...
	var tests = []struct {
		...
		{"[filter:keystoneauth]\nreseller_prefix=\n''operator_roles=role1,role2",
			[]string{""},
			map[string]map[string][]string{"": map[string][]string{"operator_roles": {"role1", "role2"},
				"service_roles": {}}}},
		{"[filter:keystoneauth]\nreseller_prefix= '' , '' \n",
			[]string{""},
			map[string]map[string][]string{"": defaultRules}},
		...
		{"[filter:keystoneauth]\nreseller_prefix= PRE1, PRE2\n" +
			...
			[]string{"PRE1_", "PRE2_"},
			map[string]map[string][]string{"PRE1_": map[string][]string{"operator_roles": {"role1", "role2"},
				"service_roles": {"role3", "role4"}},
				"PRE2_": map[string][]string{"operator_roles": {"role5"},
					"service_roles": {"role6"}}}},
		{"[filter:keystoneauth]\nreseller_prefix= AUTH ,'', PRE2\n" +
			...
			"PRE2_service_roles=role6\n",
			[]string{"AUTH_", "", "PRE2_"},
			map[string]map[string][]string{"AUTH_": map[string][]string{"operator_roles": {"role1", "role2"},
				"service_roles": {"role3", "role4"}},
				"": map[string][]string{"operator_roles": {"role1", "role2"},
					"service_roles": {"role3", "role4"}},
				"PRE2_": map[string][]string{"operator_roles": {"role5"},
					"service_roles": {"role6"}}}},
		{"[filter:keystoneauth]\nreseller_prefix=AUTH ,, PRE2\n" +
			...
			"PRE2_service_roles=role6\n",
			[]string{"AUTH_", "PRE2_"},
			map[string]map[string][]string{"AUTH_": map[string][]string{"operator_roles": {"admin", "swiftoperator"},
				"service_roles": {}},
				"PRE2_": map[string][]string{"operator_roles": {"role5"},
					"service_roles": {"role6"}}}},
	}
